const CACHE = 'recebimentos-v62';
const ASSETS = ['./','./index.html','./css/styles.css?v=62','./css/betting-theme.css?v=62','./js/payment-history-data.js?v=62','./js/app.js?v=62','./manifest.webmanifest','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png'];
