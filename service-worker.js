const CACHE = 'recebimentos-v42';
const ASSETS = ['./','./index.html','./css/styles.css?v=42','./css/betting-theme.css?v=42','./js/payment-history-data.js?v=42','./js/app.js?v=42','./manifest.webmanifest','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png'];
