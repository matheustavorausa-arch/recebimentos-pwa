const CACHE = 'recebimentos-v63';
const ASSETS = ['./','./index.html','./css/styles.css?v=63','./css/betting-theme.css?v=63','./js/payment-history-data.js?v=63','./js/app.js?v=63','./manifest.webmanifest','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png'];
