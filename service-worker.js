const CACHE = 'recebimentos-v57';
const ASSETS = ['./','./index.html','./css/styles.css?v=57','./css/betting-theme.css?v=57','./js/payment-history-data.js?v=57','./js/app.js?v=57','./manifest.webmanifest','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png'];
