const CACHE = 'recebimentos-v61';
const ASSETS = ['./','./index.html','./css/styles.css?v=61','./css/betting-theme.css?v=61','./js/payment-history-data.js?v=61','./js/app.js?v=61','./manifest.webmanifest','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png'];
