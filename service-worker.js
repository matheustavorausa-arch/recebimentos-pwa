const CACHE = 'recebimentos-v36';
const ASSETS = ['./','./index.html','./css/styles.css?v=36','./css/betting-theme.css?v=36','./js/payment-history-data.js?v=36','./js/app.js?v=36','./manifest.webmanifest','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png'];
