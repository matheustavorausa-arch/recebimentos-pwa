const CACHE = 'recebimentos-v30';
const ASSETS = ['./','./index.html','./css/styles.css?v=30','./css/betting-theme.css?v=30','./js/payment-history-data.js?v=30','./js/app.js?v=30','./manifest.webmanifest','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png'];
