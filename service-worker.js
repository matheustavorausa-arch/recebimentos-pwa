const CACHE = 'recebimentos-v52';
const ASSETS = ['./','./index.html','./css/styles.css?v=52','./css/betting-theme.css?v=52','./js/payment-history-data.js?v=52','./js/app.js?v=52','./manifest.webmanifest','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png'];
