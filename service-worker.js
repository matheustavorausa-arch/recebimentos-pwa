const CACHE = 'recebimentos-v58';
const ASSETS = ['./','./index.html','./css/styles.css?v=58','./css/betting-theme.css?v=58','./js/payment-history-data.js?v=58','./js/app.js?v=58','./manifest.webmanifest','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png'];
