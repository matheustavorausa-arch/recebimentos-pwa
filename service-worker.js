const CACHE = 'recebimentos-v68';
const ASSETS = ['./','./index.html','./css/styles.css?v=68','./css/betting-theme.css?v=68','./js/payment-history-data.js?v=68','./js/app.js?v=68','./manifest.webmanifest','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png'];
