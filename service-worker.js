const CACHE = 'recebimentos-v38';
const ASSETS = ['./','./index.html','./css/styles.css?v=38','./css/betting-theme.css?v=38','./js/payment-history-data.js?v=38','./js/app.js?v=38','./manifest.webmanifest','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png'];
