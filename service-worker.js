const CACHE = 'recebimentos-v35';
const ASSETS = ['./','./index.html','./css/styles.css?v=35','./css/betting-theme.css?v=35','./js/payment-history-data.js?v=35','./js/app.js?v=35','./manifest.webmanifest','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png'];
