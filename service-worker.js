const CACHE = 'recebimentos-v51';
const ASSETS = ['./','./index.html','./css/styles.css?v=51','./css/betting-theme.css?v=51','./js/payment-history-data.js?v=51','./js/app.js?v=51','./manifest.webmanifest','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png'];
