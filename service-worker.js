const CACHE = 'recebimentos-v37';
const ASSETS = ['./','./index.html','./css/styles.css?v=37','./css/betting-theme.css?v=37','./js/payment-history-data.js?v=37','./js/app.js?v=37','./manifest.webmanifest','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png'];
