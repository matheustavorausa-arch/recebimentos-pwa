const CACHE = 'recebimentos-v73';
const ASSETS = ['./','./index.html','./css/styles.css?v=73','./css/betting-theme.css?v=73','./js/payment-history-data.js?v=73','./js/app.js?v=73','./manifest.webmanifest','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png'];
