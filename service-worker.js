const CACHE = 'recebimentos-v59';
const ASSETS = ['./','./index.html','./css/styles.css?v=59','./css/betting-theme.css?v=59','./js/payment-history-data.js?v=59','./js/app.js?v=59','./manifest.webmanifest','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png'];
