const CACHE = 'recebimentos-v31';
const ASSETS = ['./','./index.html','./css/styles.css?v=31','./css/betting-theme.css?v=31','./js/payment-history-data.js?v=31','./js/app.js?v=31','./manifest.webmanifest','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png'];
