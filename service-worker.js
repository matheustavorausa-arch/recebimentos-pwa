const CACHE = 'recebimentos-v69';
const ASSETS = ['./','./index.html','./css/styles.css?v=69','./css/betting-theme.css?v=69','./js/payment-history-data.js?v=69','./js/app.js?v=69','./manifest.webmanifest','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png'];
